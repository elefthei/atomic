...
function buildPrepareReport(args: {
  ...
  return [
    ...
    "2. Confirm scope: main LinkedIn Messaging inbox unread conversations only; generate follow-up text from those conversations and sender profiles.",
    ...
    "5. Confirm personalization depth: reuse the LinkedIn connect workflow's visible-profile inspection depth — Experience, About, Featured, and Activity when visible.",
