...
| 2 | Before / After | Diptych | `After` | `liquid-silk--warm` ↔ `liquid-silk--cool` |
| 3 | Workflow-as-code | Dark + cool edge | — | Mocha + cool silk right edge |
| 4 | Architecture | Light cream | — | `liquid-silk--cream` (cool right bleed) |
| 5 | Use cases | Dark + cool corner | — | Mocha + cool silk top-right |
